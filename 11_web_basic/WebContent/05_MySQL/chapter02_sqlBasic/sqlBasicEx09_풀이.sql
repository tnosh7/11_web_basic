...
SELECT 
		SALARY ,
        SALARY + (SALARY - SALARY * 0.9) AS BONUS
FROM 
		SALARIES;
...
FROM 
		DEPT_MANAGER 
WHERE 
		DEPT_NO = 'd001' AND TO_DATE >= '1990-01-01'
ORDER BY 
		TO_DATE; 
